...
# To learn more about form objects check out https://github.com/tianlu1677/yaaf#links
#
# You should inherit from ApplicationForm in order to use form objects,
# to learn more about using the gem check out https://github.com/tianlu1677/yaaf
